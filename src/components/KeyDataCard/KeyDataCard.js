...
/**
 * Component for generate card of key data with type
 * 
 * @param {number} data
 ...
 * const data = 1930
 * return (
 *  <KeyDataCard dataType={"calorie"} data={data} />
    <KeyDataCard dataType={"proteine"} data={data} />
    <KeyDataCard dataType={"glucide"} data={data} />
    <KeyDataCard dataType={"lipide"} data={data} />
 * )
 */
function KeyDataCard(props) {
  const data = props.data;
  const dataType = props.dataType;
  const className = 'keyDatas__card ' + dataType;
  ...
  return (
    <div className={className}>
      <div className='keyDatas__card__icon'>
        {icon}
      </div>
      <div className='keyDatas__card__content'>
        <h3>{title}</h3>
        <h4>{dataType}</h4>
      </div>
    </div>
